...
// No "use client" — this is now a pure Server Component. All the old
// useState, useEffect, useQuery, and tab logic is gone. There's nothing
// here that needs to run in the browser, so Next.js ships zero JS bundle
// for this route. Verify in DevTools → Sources: no JS chunk specific to
// the home route will appear.
